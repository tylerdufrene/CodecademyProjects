...
possible_ms = [(i * 0.1) for i in range(-100, 100, 1)]#your list comprehension here
...
possible_bs = [(i * 0.1) for i in range(-200, 200, 1)] #your list comprehension here
...
for m in possible_ms:
    for b in possible_bs:
        x = calculate_all_error(m,b,datapoints)
        if x < smallest_error:
            best_m = m
            best_b = b
            smallest_error = x
